...
VM_TYPE={{getVMType .ClusterConfig.GetVmType}}
...
NETWORK_PLUGIN={{getNetworkPlugin .GetNetworkConfig.GetNetworkPlugin}}
NETWORK_POLICY="{{getNetworkPolicy .GetNetworkConfig.GetNetworkPolicy}}"
...
LOAD_BALANCER_SKU={{getLoadBalancerSKU .ClusterConfig.GetLoadBalancerConfig.GetLoadBalancerSku}}
